...
public class Entity : MonoBehaviour
{
    ...
    [SerializeField] protected float groundCheckDistance = .6f;
    ...
    public virtual bool IsBackWallDetected() => Physics2D.Raycast(wallCheck.position, Vector2.left * facingDir, wallCheckDistance, whatIsGround);
