...
public class UI_SkillToolTip : UI_ToolTip
{
    ...
    [SerializeField] private TextMeshProUGUI skillHotKey;
    [SerializeField] private float defaultNameFontSize;
    
    public void ShowToolTip(string _skillDescprtion,string _skillName,int _price,string _hotkey)
    {
