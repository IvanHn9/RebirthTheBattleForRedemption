...
public class Archer_JumpState : EnemyState
{
    ...
    public Archer_JumpState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName,Archer enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = enemy;
    }
